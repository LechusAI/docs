...
description: "Crea una biblioteca compartida de Archivos y URLs web que tus agentes de IA pueden consultar para responder con mayor precisión."
---
...
> **Consejo:** Piensa en la Base de conocimiento como “material de referencia aprobado” que el agente puede consultar cuando un cliente hace preguntas detalladas.

## Cómo se conecta con los agentes de IA

No añades el contenido directamente dentro de un agente. En su lugar:
1. Creas el contenido de la Base de conocimiento aquí (Archivos o URLs web).
2. Luego, al editar un agente, **seleccionas el grupo de Base de conocimiento** que quieres que use ese agente.

> **Importante:** Si actualizas un grupo de Base de conocimiento y quieres que los cambios afecten a un agente existente, puede que tengas que volver al editor del agente y hacer clic en una acción de **Update** en la sección de Base de conocimiento (esto puede variar según tu cuenta/plan).

## Base de conocimiento con Archivos
...
<p style={{ marginTop:"0", marginBottom:"1.5rem", color:"#6b7280", fontSize:"0.95rem" }}>
  Captura: La Base de conocimiento en modo Archivos, donde subes documentos y los organizas en grupos.
</p>
...
Una vez que existe un grupo, puedes abrirlo para administrar lo que contiene:
...
## Base de conocimiento con URLs web
...
Cuando ya existe un grupo de URLs, puedes gestionarlo desde la lista:
...
Después de crear tus grupos (Archivos o URLs web), los asignas a un agente durante la edición del agente.
