...
<div style={{ border:"2px solid #e5e7eb", borderRadius:"12px", padding:"8px", boxShadow:"0 4px 12px rgba(0,0,0,0.10)", maxWidth:"100%", overflow:"hidden", backgroundColor:"#0b0b0b", marginBottom:"0.75rem" }}>
  <img src="/images/actions1.png" alt="The Actions page in Callin, showing integration cards like Google Calendar, Cal.com, GoHighLevel, Zoho, n8n, Zapier, Make.com, Slack (Coming Soon), and Custom Integration." style={{ width:"100%", display:"block" }} />
</div>
...
**What it’s for**<br />Use Google Calendar to keep appointments organized in a calendar your team already uses.
...
**What it’s for**<br />Cal.com is an appointment scheduling platform. Connecting it can help align Callin with your scheduling setup.
...
**What it’s for**<br />GoHighLevel is a CRM platform. Connecting it helps you keep customer and lead information aligned between Callin and your CRM workflows.
...
**What it’s for**<br />Zoho is another CRM option. Use it if your team manages leads, contacts, or customer records in Zoho.
...
**What it’s for**<br />n8n is a workflow automation platform. It’s useful when you want to build custom automations that connect multiple tools together.
...
**What it’s for**<br />Zapier helps you connect Callin to thousands of apps and automate simple workflows without custom development.
...
**What it’s for**<br />Make (formerly Integromat) is another automation platform for building multi-step scenarios across tools.
...
**What it’s for**<br />Slack is commonly used for team notifications and internal communication.

**Availability**<br />In the screenshot, Slack shows **Coming Soon**, which means it’s visible in Actions but not available to connect yet.
...
**What it’s for**<br />Custom Integration is for teams that want to connect Callin to their own systems or external services via webhooks.
