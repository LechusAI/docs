...
description: "In this section, you’ll find a detailed overview of all inbound and outbound calls made through your Callin.io AI agents."
---
...
- Any linked **appointment** or **automated process** triggered during the call.
  ...
  This log is essential for performance analysis, auditing, and troubleshooting.  
  It provides your team with accurate, real-time records of every customer interaction made through the platform.

  ![Call History Overview](/gifs/callg1.gif)
